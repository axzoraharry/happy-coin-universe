...
-- Fix the secure payment processing function to handle foreign key constraints properly
...
BEGIN
  ...
  BEGIN
    -- Create transaction record FIRST (to satisfy foreign key constraint)
    INSERT INTO public.transactions (
      ...
      'external_payment', COALESCE(p_description, 'External payment'), 'completed', v_reference_id
    );
